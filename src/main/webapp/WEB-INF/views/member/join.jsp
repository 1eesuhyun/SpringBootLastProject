...
<!-- ****** Breadcumb Area Start ****** -->
    ...
    <!-- ****** Archive Area Start ****** -->
    <section class="archive-area section_padding_60" id="join_section">
			        ...
			        <tr>
			          ...
			          <td>
			            <div class="form-inline">
			              ...
			              <button type="button" class="btn btn-mint btn-sm" @click="idCheck()">중복체크</button><span style="margin-left: 10px;color: red;">{{idOK}}</span>
			            </div>
			          </td>
			        </tr>
			        <tr>
			        ...
			        <tr>
			          ...
			          <td>
			            <div class="form-inline">
			              ...
			              <input type="text" name="phone2" v-model="phone2" class="form-control input-sm">
			            </div>
			          </td>
			        </tr>
